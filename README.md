...
```
##### Note:
If key or the massage contain backward slash the JS engine fill interpret it as a escape sequence character "\" and the funcion produces digest like there is no escape sequence character present, in both strings.
